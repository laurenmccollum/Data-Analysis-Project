...
#need to somehow take into account large error bars and disregard this values
#have to write some code to do this?
#something like if the value of the error bar is larger than x then = 0 and the corresponding point = 0